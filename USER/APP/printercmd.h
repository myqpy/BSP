...
//extern unsigned char DriversLicenseNum[]  ;//¡¶»ú¶¯³µ¼ÝÊ»Ö¤ºÅÂë£º¡·    ºº×Ö±àÂë
//extern unsigned char Speed_Status[] ; //¡¶ËÙ¶È×´Ì¬£º¡·    ºº×Ö±àÂë
//extern unsigned char Print_Time[] ;//¡¶´òÓ¡Ê±¼ä£º¡·    ºº×Ö±àÂë
//extern unsigned char OverSpeedRecord[];//¡¶Á½¸öÈÕÀúÌìÄÚ³¬Ê±¼ÝÊ»¼ÇÂ¼£º¡·    ºº×Ö±àÂë
...
//extern unsigned char car_plate_province_Xin[]	;/*"ÐÂ",27*/
//extern unsigned char car_plate_province_Zang[]	;/*"²Ø",28*/
//extern unsigned char car_plate_province_Ning[]	;/*"Äþ",29*/
//extern unsigned char car_plate_province_Gui[]	;/*"¹ð",30*/
